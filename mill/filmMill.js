...
const w = Number(book.filmwidth), h = Number(book.filmheight);
const m = Number(book.bookmargin);
const width = book.filmwidth+book.bookunits;
const height = book.filmheight+book.bookunits;
...
const svgwidth = book.filmwidth*book.pixelsperunit;
const svgheight = book.filmheighti*book.pixelsperunit;
let dt = new Date();
